...
class PublicUserApiTest(TestCase):
    ...
    def test_create_invalid_credentials(self):
        ...
        create_user(email='janedoe@gmail.com', password='password123')
        payload = {
            'email': 'janedoe@gmail.com',
            'password': 'wrongpass'
        }
    ...
    def test_create_token_missing_field(self):
        """Test that for creating token email and password is required"""
...
class PrivateUsersApiTest(TestCase):
    ...
    def test_update_user_profile(self):
        ...
        payload = {'name': 'john', 'password': 'newpassword123'}
